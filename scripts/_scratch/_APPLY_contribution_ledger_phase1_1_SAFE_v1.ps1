...
[System.IO.File]::WriteAllBytes((Join-Path $TV "build_result.json"),(CL-CanonJsonBytes $out))
...
Write-Host "APPLY_OK: SAFE lib+build+verify+selftest written+parse_ok" -ForegroundColor Green
...
Write-Host "FINAL_OK: CONTRIBUTION_LEDGER_SAFE_APPLY_V1" -ForegroundColor Green
